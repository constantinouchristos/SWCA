...
class BertEmbeddings_c(BertEmbeddings):
    
    def __init__(self, config):
        super(BertEmbeddings_c,self).__init__(config)
...
class BertModel_c(BertModel):
    
    def __init__(self, config):
        super(BertModel_c,self).__init__(config)
...
#         # bert ouput
#         bert_pooled,w_emb = self.bert(**inputs_bert)
...
#         if return_h:
#             return tag_space,h,w_emb
#         else:
#             return tag_space,w_emb
